...
import (
	...
	"github.com/ganben/go-ethereum/common/hexutil"
	...
	ethMetrics "github.com/ganben/go-ethereum/metrics"
	"github.com/ganben/go-ethereum/miner"
...
func (api *PublicGethAPI) GetAddressTransactions(address common.Address, blockStartN uint64, blockEndN rpc.BlockNumber, toOrFrom string, txKindOf string, pagStart, pagEnd int, reverse bool) (list []string, err error) {
	...
	// Use human-friendly abbreviations, per https://github.com/ganben/go-ethereum/pull/475#issuecomment-366065122
...
// See https://github.com/ganben/go-ethereum/wiki/Metrics-and-Monitoring for prophetic documentation.
